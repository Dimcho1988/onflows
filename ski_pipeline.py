...
# -------------------------------------------------
# Public API aliases (за да НЕ се чупи import-а ако някъде има старо име)
# -------------------------------------------------
process_ski_activity = process_ski_activity_30s
process_ski_activity_30 = process_ski_activity_30s
