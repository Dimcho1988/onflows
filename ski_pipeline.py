...
def process_ski_activity_30s(
    ...
    seg30["zone"] = assign_speed_zones(seg30["v_flat_eq"].to_numpy(dtype=float), V_crit=float(V_crit) if V_crit else np.nan)
    seg30 = add_hr_zone_ranked(seg30, zone_col="zone", hr_col="hr_mean")

    return seg30, seg7


# Backward/forward compatible aliases (avoid import errors)
...
__all__ = [
    ...
    "process_ski_activity_30s",
    "get_glide_training_segments",
    "fit_glide_poly",
    "get_slope_training_data_out",
    "fit_slope_poly",
]
